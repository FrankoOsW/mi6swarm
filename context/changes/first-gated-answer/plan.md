...
- [ ] 3.1 `rg "TBD — see §3 Phase 2" context/foundation/test-plan.md` finds no matches
- [ ] 3.2 §6.3 contains Location, Naming, Reference, Run, Pattern
- [ ] 3.3 `pipenv run pytest tests/ -v` still passes

#### Manual

- [ ] 3.4 A teammate could add a fifth fixture case from §6.3 alone
- [ ] 3.5 §1–§5 risk map text is unchanged except any Status cell the implementer is explicitly allowed to touch
