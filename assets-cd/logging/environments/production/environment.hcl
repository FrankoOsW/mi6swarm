...
*/
inputs = {
  aws_account_ids         = ["021427824859"]
  environment             = "production"
  env_code                = "prd"
  remote_state_bucket     = "terraform-olxeu-tooling-production-eu-west-1"
  terraform_pipeline_role = "arn:aws:iam::555677789327:role/atlantis"
}
